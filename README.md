...
![Analysis](https://img.shields.io/badge/Method-Spatial%20Lag%20Model-orange)
...
<img width="644" alt="Choropleth Map" src="https://github.com/user-attachments/assets/f634904c-0792-4770-bf33-b44a5f8f08d9">
<img width="717" alt="LISA Cluster Map" src="https://github.com/user-attachments/assets/3ca1cb4b-412c-4fe1-b13f-87a28d7d9af7">
...
**3. Software**
- All analyses conducted in **Python** using spatial and statistical libraries (`geopandas`, `pysal`, `statsmodels`).
